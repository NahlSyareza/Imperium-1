...
public class ModItems {
    ...
    public static final DeferredItem<Item> IRON_LEGION_SWORD = ITEMS.register("iron_legion_sword", () -> new LegionSwordItem(ModTiers.IRON_LEGION, new Item.Properties().attributes(SwordItem.createAttributes(ModTiers.IRON_LEGION, 4, -1.2F))));
