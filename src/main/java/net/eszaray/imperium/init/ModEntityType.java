...
public class ModEntityType {
    ...
    public static final Supplier<EntityType<TribesmanChieftain>> TRIBESMAN_CHIEFTAIN = ENTITY_TYPE.register("tribesman_chieftain", () -> EntityType.Builder.of(TribesmanChieftain::new, MobCategory.CREATURE).sized(0.6F, 1.8F).build("tribesman_chieftain"));
